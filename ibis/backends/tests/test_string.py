...
@pytest.mark.parametrize(
    ...
    [
        param(
            ...
            marks=[
                pytest.mark.notimpl(
                    ["datafusion", "oracle"], raises=com.OperationNotDefinedError
                ),
                pytest.mark.broken(
                    ["mssql"],
        ...
        param(
            ...
            id='find',
            marks=pytest.mark.notimpl(
                ["datafusion", "polars", "oracle"], raises=com.OperationNotDefinedError
            ),
        ),
        param(
...
@pytest.mark.notimpl(["druid", "oracle"], raises=com.IbisTypeError)
